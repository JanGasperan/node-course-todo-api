...
describe('POST /todos', () => {
  ...
  describe('DELETE /todo/:id', () => {
    ...
    it('should NOT remove a todo for unautorized user', (done) => {
    ...
    it('should update the todo', (done) => {
      ...
      request(app)
        ...
        .expect((res) => {
          ...
          //expect(res.body.todo.completedAt).toBeA("number"); old version
          expect(typeof res.body.todo.completedAt).toBe('number');
        })
        .end(done);
    });

    it('should NOT update the todo for unautorized user', (done) => {
      var hexId = todos[0]._id.toHexString();
      var updateTodo = {text : "Some new text", completed: true};
      request(app)
        .patch(`/todos/${hexId}`)
